          ...
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-yellow-700">
                <span class="font-bold">Farming is still in development</span><br>
                You may experience bugs when interacting with the interface, refresh the page if anything goes wrong.
              </p>
            </div>
          </div>
        </div>
